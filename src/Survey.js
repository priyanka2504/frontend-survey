...
class Survey extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      Workshop: "",
      Important: "",
      thankyouComponent: false
    }
  }


  handlePost = () => {
    const { state } = this.state.thankyouComponent
  ...
  render() {
    ...
    return (
      <div className="App">
        {this.state.thankyouComponent ? <ThankYou /> :
          <div>
                  ...
                  <div class="col">
                    ...
                    <div class="container">
                      <div class="row">
                        ...
                        <div class="col-sm">
                          <input type="checkbox" name="react" value="none" onChange={this.handleListChange} /> None
    </div>
                      </div>
                    </div>
              ...
              <div class="container">
                <div class="row">
                  ...
                  <div class="col">
                    ...
                    <div class="row">
                      <div class="col"> <input type="radio" name="one" id="list" value="Important" checked={Important === 'Important'} onChange={this.handleImportantChange} /> Important</div>
                      <div class="col">  <input type="radio" name="one" id="list" value="very important" checked={Important === 'very important'} onChange={this.handleImportantChange} /> Very Important</div>
                      <div class="col"> <input type="radio" name="one" id="list" value="not important" checked={Important === 'not important'} onChange={this.handleImportantChange} /> Not Important</div>
                      <div class="col"> <input type="radio" name="one" id="list" value="cant say" checked={Important === 'cant say'} onChange={this.handleImportantChange} /> Can't say</div>
                    </div>
              ...
              <div class="container">
                <div class="row">
                  <div class="col" align="right">
                    <button type="button" class="btn btn-primary btn-lg md-2" onClick={this.handleReset}>Cancel</button>
                  </div>
                  <div class="col">
                    <button className="two" type="button" class="btn btn-primary btn-lg mb-2" onClick={this.handlePost}> Submit
                    {/* <a href="/thankyou"> Submit </a>  */}
                    </button>
                  </div>
                </div>
              </div>
